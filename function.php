<?php 
    function Generate($passLength,$ripetition,$passNum,$passSpec){
                ...
                if($ripetition=='no-repeat'){
                    ...
                    if($passNum=='add'&& $passSpec=='add'){
                                                ...
                                                if($char==3){
                                                    ...
                                                    while($isInSpecial){
                                                        ...
                                                        if(in_array($special[$randomIndex],$specialUsed)){
                                                            ...
                                                            array_push($specialUsed,$special[$randomIndex]);
                                                            $isInSpecial=false;
                                                        }
                                                    }
                                                } 
                        ...
                        if($passNum=='add'){
                            ...
                            //case of adding special charachters
                        }else{
                            if($passSpec=='add'){
                                for ($i=0; $i < $passLength; $i++) { 
                                    $isFull=true;
                                        while($isFull){
                                            if(count($lowercaseUsed)==count($letters)||count($uppercaseUsed)==count($upperCase)||count($specialUsed)==count($special)){
                                                $isFull=true;
                                            }else{
                                                $char=rand(1,3);
                                                if($char==1){
                                    ...
                                    for ($i=0; $i < $passLength; $i++) { 
                                        $isFull=true;
                                            while($isFull){
                                                if(count($lowercaseUsed)==count($letters)||count($uppercaseUsed)==count($upperCase)){
                                                    $isFull=true;
                                                    }else{
                                                        $char=rand(1,2);
                                                        if($char==1){
